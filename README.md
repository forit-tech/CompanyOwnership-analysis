...
(чтобы просмотреть нажмите на [ссылку](https://company-ownership-analysis.vercel.app/) или кнопку ниже)

[![Live Demonstration](https://img.shields.io/badge/Live-Dashboard-7C3AED?style=for-the-badge&logo=vercel&logoColor=white)](https://company-ownership-analysis.vercel.app/)

Интерактивный data product для анализа владельцев, компаний, долей и источников.  
Позволяет за 30–60 секунд получить понимание структуры данных и перейти к детальному анализу.
